...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (name) {
...
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(2).find('.more')); // $('button').html('LOLO');
